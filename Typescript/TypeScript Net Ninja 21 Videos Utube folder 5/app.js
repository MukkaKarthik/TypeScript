...
var form1 = document.querySelector('.new-item-form'); //typescript doesn't exactly know it is an HTML element as it a class which can apply across any tag
...
let r1 = { PagesPresent: 23, BookName: "Bibilograpghy", indexPresent: true, topics: "Chapter 1" };
let r2 = { PagesPresent: 23, BookName: "Bibilograpghy", indexPresent: true, topics: 23 };
let r3 = { PagesPresent: 23, BookName: "Bibilograpghy", indexPresent: true, topics: false };
let r4 = { PagesPresent: 23, BookName: "Bibilograpghy", indexPresent: true, topics: { name: "Chapter 1", pagesRequired: true } };
...
var RememberFilmType;
(function (RememberFilmType) {
    RememberFilmType[RememberFilmType["Patriotic Movie"] = 0] = "Patriotic Movie";
    RememberFilmType[RememberFilmType["Romantic Drama"] = 1] = "Romantic Drama";
    RememberFilmType[RememberFilmType["Comedy Thriller"] = 2] = "Comedy Thriller";
    RememberFilmType[RememberFilmType["Horror Movie"] = 3] = "Horror Movie";
})(RememberFilmType || (RememberFilmType = {}));
let f1 = { FilmIndexNo: 45, filmName: "Chak De India", MovieType: RememberFilmType["Patriotic Movie"] };
let f2 = { FilmIndexNo: 23, filmName: "Interstellar", MovieType: RememberFilmType["Horror Movie"] };
let f3 = { FilmIndexNo: 99, filmName: "Inception", MovieType: RememberFilmType["Romantic Drama"] };
let f4 = { FilmIndexNo: 123, filmName: "Mission Impossible", MovieType: RememberFilmType["Comedy Thriller"] };
