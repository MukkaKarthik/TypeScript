...
let unique_identifier : string | number ;
...
const add = (a:number , b:number , c: number | string = "c value is default") => {
...
const plus = (a:number , b:number):number =>//explicity declaring function return type 
{
    return (a+b);
}
...
let greet10 = (user : {Language : string , Framework : string , Period : number}) => 
{
...
type ObjectProperties = {Language : StringOrNumber, Framework:StringOrNumber, Period : StringOrNumber };


var use_variable1 = "Using this value in function";

//Replacing string | number with StringOrNumber 
let greet1 = (user1 : {Language : StringOrNumber , Framework : StringOrBoolean , Period : number | boolean}) => 
{
...
let greet2 = (user2 : ObjectProperties) => 
{
...
type Object_using = {Name_channel : string | Number , Age_wise : Number};

let  logDetails =  (Object_usingTemp : Object_using) =>
{
