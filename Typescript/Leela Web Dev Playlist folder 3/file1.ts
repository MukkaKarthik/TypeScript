...
const button = document.querySelector("#Add_here")!;
...
function addition_2numbers(num1:number , num2:number) :  number//explicitly mention argument type 
{
return num1 + num2;
}
...
//Output :- 
Driving car ...
file1.js:469 Driving car ...
file1.js:477 Driving truck
file1.js:480 Loading luggage in truck = 30
*/



//Video 42
//Discriminated union types in javascript 
...
type animal = Snake | Bird | Horse;

function CheckAnimalSpeed(ani : animal)
{
    ...
    let speed_switch : any = "";

    switch(ani.type_animal)
    {
        case "bird" : speed_switch = ani.flyingSpeed;
        break;

        case "horse" : speed_switch = ani.RunningSpeed;
        break;

        case "snake" : speed_switch = ani.CrawlingSpeed;
        break;
    }
...
//Animal type Speed =  50

//file1.js:521 Speed of the animal = 50

//types are used to combine variables 

type Maths1 =  number | string;
type Maths2 = string  | number;

type Maths3 = Maths1 & Maths2;

let Maths_variable : Maths3 = 34;




function add_types( a1 :Maths1 , b1 : Maths2)
{
...
const Add_result = add_types(12,20) as number;
console.log(Add_result);

const Add_result1 = add_types(12,"Bangalore") as string;//typecasting the variables 
...
const Add_result2 = add_types(12,20) as string;
console.log(Add_result2);



//defining function declarations 
function Result_types( a1 :string , b1 : string) : string;
function Result_types( a1 :number , b1 : string) : string;
function Result_types( a1 :string , b1 : number) : string;
function Result_types( a1 :number , b1 : number) : number;

//is possible with only 1 variable if it is declared as optional  



function Result_types( a1 :Maths2 , b1 : Maths1 , c1? : string)
{
...
let Result_types_variable1= Result_types(12,20);
console.log(Result_types_variable1);

let Result_types_variable2= Result_types(12,"string");
console.log(Result_types_variable2);


let Result_types_variable3= Result_types("string",20);
console.log(Result_types_variable3);


let Result_types_variable4= Result_types("string2","string1");
