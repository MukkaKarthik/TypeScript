...
console.log((_a = userDate === null || userDate === void 0 ? void 0 : userDate.financialDetails) === null || _a === void 0 ? void 0 : _a.Month); //Optional parameter chaining  
var userInput = null;
var ServerDate = userInput || "default";
console.log(ServerDate); //default 
//we get this output as userInput is null , so return default as the value
var userInput1 = "";
var ServerDate1 = userInput1 || "default";
console.log(ServerDate1); //default 
var userInput2 = "input value given";
var ServerDate2 = userInput2 || "default";
console.log(ServerDate2); //input value given
//Null coalescing 
var userInput3 = "";
//Use question mark only for null and undefined , but not for ""
var ServerDate3 = userInput3 !== null && userInput3 !== void 0 ? userInput3 : "default";
...
var Company = /** @class */ (function () {
    function Company() {
        this.message = "Hello world , developer programmer";
    }
...
var c = new Company();
var button_element = document.getElementById("decorator_id");
...
var form_element = document.getElementById("form_course");
form_element.addEventListener("click", function (eventCustomObject) {
    eventCustomObject.preventDefault();
    var title_element = document.getElementById("Course_title");
    var price_element = document.getElementById("Course_price");
    var button_element_course = document.getElementById("form_course_button");
    var title_element_value = title_element.value;
    var price_element_value = parseInt(price_element.value);
