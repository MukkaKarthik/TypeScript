...
var Number1_element = document.getElementById("Number1") as HTMLInputElement;
var Number2_element = document.getElementById("Number2") as HTMLInputElement;
...
function add_number(add_num1 : any,add_num2 : any,showValue : boolean,phrase_given : string)
{
...
const num_value1 = 4;
const num_value2 = 'string word';
const printValue = true;
const phrase =  "Result after operation : ";
...
function operation(var1 : number , var2 : number) :number
{
    return var1 + var2;
}

function printResult(result : number) : void //: undefined if declared this way , will throw an error 
{
    console.log("Result = " + result);//return type is void
}

function printResult1(result : number) : undefined //: undefined if declared this way , will throw an error 
{
    console.log("Result = " + result);//return type is void
...
let a = function(a1 : string , a2 : Array<string>) : Array<string> | number
{
return [""];
}

let helloFunction : Function = a;
...
let b_element = document.querySelector("button") as HTMLButtonElement;
...
function addPositive_Numbers(a: number , b: number)
{
    if(a + b > 0)
    {
        return a+b;
